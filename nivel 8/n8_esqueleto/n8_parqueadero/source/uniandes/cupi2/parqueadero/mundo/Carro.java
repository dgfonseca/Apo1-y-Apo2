...
public class Carro implements Serializable
{
	...
	// -----------------------------------------------------------------
	/**
     * Enumera la cantidad de días que lleva el carro en el parqueadero.
     */
    private int dias;
	/**
	 * Placa del carro.
	...
	/**
     * Avanza en una unidad el contador de días.
     */
    ...
    {
        int tiempoParqueadero = (pHoraSalida - horaIngreso + 1) + (dias * 24);
