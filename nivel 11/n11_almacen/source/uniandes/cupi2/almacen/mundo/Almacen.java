...
public class Almacen
{
	...
	public void agregarNodo( String pIdPadre, String pTipo, String pIdentificador, String pNombre ) throws AlmacenException
	{
		...
		{
			throw new AlmacenException("No se puede agregar");

		}


		// TODO HECHO Parte4 PuntoA Complete el método según la documentación dada.
	}
	...
	public Categoria eliminarNodo( String pIdNodo ) throws AlmacenException
	{
		if(categoriaRaiz==null)
		{
			throw new AlmacenException("Nodo Invalido");

		}
		if(categoriaRaiz.darIdentificador().equalsIgnoreCase(pIdNodo))
		{
			if(categoriaRaiz.esHoja())
			{
				categoriaRaiz=null;
				return categoriaRaiz;
			}
			...
			{
				throw new AlmacenException("Error");
			}			
		}
		else
		{
			Categoria padre = categoriaRaiz.buscarPadre(pIdNodo);

			if( padre == null )
				throw new AlmacenException( "Invalido" );

			padre.eliminarNodo(pIdNodo);
			return padre;
		}

		// TODO HECHO Parte4 PuntoB Complete el método según la documentación dada.
	}
	...
	{
		Producto producto= categoriaRaiz.buscarProducto(pCodigo);
	...
	{
		return categoriaRaiz == null ? null : categoriaRaiz.buscarNodo(pIdNodo);
		// TODO HECHO Parte4 PuntoD Complete el método según la documentación dada.
	}
	...
	{
		Marca m =(Marca) categoriaRaiz.buscarNodo(pIdMarca);
		m.agregarProducto(pCodigo, pNombre, pDescripcion, pPrecio);
	 ...
	 * <b>pre: </b> La categoría raíz está inicializada y existe el producto con el código dado. <b>post: </b>Se eliminó el producto.
	 * @param pCodigo Código del producto. pCodigo != null && pCodigo != "".
	 */
	public void eliminarProducto( String pCodigo )
	{List<Marca> productos = darCategoriaRaiz( ).darMarcas( );
	Boolean termino = false;
	if(categoriaRaiz.darProductos()==null)
	{
		productos.clear();
	}
	...
	{
		Marca prod = productos.get(i);
		Boolean x = prod.eliminarProducto(pCodigo);
