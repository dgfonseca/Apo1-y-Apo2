...
public class Producto
{
	...
	public int darPeso( )
	{
		int p1 = ( hijoIzquierda == null ) ? 0 : hijoIzquierda.darPeso( );
		int p2 = ( hijoDerecha == null ) ? 0 : hijoDerecha.darPeso( );
		return 1 + p1 + p2;
		// TODO HECHO Parte1 PuntoA Complete el método según la documentación dada.
	}
	...
	{
		if( comparar( pProducto.darCodigo() ) == 0 )
			throw new AlmacenException( pProducto.nombre );
		...
		// TODO HECHO Parte1 PuntoB Complete el método según la documentación dada.
	}
	...
	{
		if( codigo.compareToIgnoreCase( pCodigo ) == 0 )
		{
			return this;
		}
		else if( codigo.compareToIgnoreCase( pCodigo ) > 0 )
		{
			return ( hijoIzquierda == null ) ? null : hijoIzquierda.buscarProducto ( pCodigo );
		}

		else {
			return ( hijoDerecha == null ) ? null : hijoDerecha.buscarProducto ( pCodigo );
		}
	}


	// TODO HECHO Parte1 PuntoC Complete el método según la documentación dada.
	...
	public void darInorden( List<Producto> pAcumulado )
	{
		...
		// TODO HECHO Parte1 PuntoD Complete el método según la documentación dada.
