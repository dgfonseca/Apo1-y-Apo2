...
public class DialogoRegistrar extends JDialog implements ActionListener
{
	 ...
	 */
	//TODO HECHO Parte 5 punto 1: Declarar el atributo rbtnCategorias, la lista de radioButtons para las categorías.
	...
	public DialogoRegistrar( InterfazTiendaLibros pPrincipal )
	{
		...
		//TODO HECHO Parte 5 punto 2: Declare la variable grupoBotones de tipo ButtonGroup para agrupar los radioButtons de las categorías.
		ButtonGroup grupoBotones = new ButtonGroup();
		//TODO HECHO Parte 5 punto 3: Inicialice el atributo rbtnCategorias.
		rbtnCategorias=new JRadioButton[6];
		for(int i = 0; i < rbtnCategorias.length; i++)
		{

			//TODO HECHO Parte 5 punto 4: Inicializar un radioButton con el texto de una de las categorías.
			//TODO HECHO Parte 5 punto 5: Adicionar el radioButton al grupo de botones.
