...
public class PanelDefinitivas extends JPanel
{
    ...
    /**
     * Muestra el porcentaje de niveles aprobados dentro del curso
     */
    private JLabel lblPorcentajeAprobados;
    ...
    public PanelDefinitivas( )
    {
        ...
        JLabel lblNivelesAprobados = new JLabel( "Niveles aprobados" );
        add( lblNivelesAprobados );

        lblPorcentajeAprobados = new JLabel( );
        add( lblPorcentajeAprobados );
     ...
     * @param pPorcentajeAprobados Porcentaje de niveles aprobados.
     */
    public void actualizar( double pNotaEjercicios, double pNotaPracticos, double pNotaTeoricos, double pNotaDefinitiva, double pPorcentajeAprobados )
    {
        ...
        lblPorcentajeAprobados.setText( formato.format( pPorcentajeAprobados ) + "%" );
    }
