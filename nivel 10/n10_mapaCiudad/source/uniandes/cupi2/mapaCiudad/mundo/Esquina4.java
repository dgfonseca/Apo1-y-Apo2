/**
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * $Id: Esquina4.java,v 1.1 2007/03/22 16:12:59 p-marque Exp $
...
public class Esquina4 extends Carretera
{
    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------    
    /**
     * Constante para definir el tipo Esquina 4.
     */
    public final static String TIPO = "ESQUINA4";
     ...
     */
    public Esquina4( int x, int y, Color colorFondo )
    {
     ...
     */
    public Esquina4( BufferedReader br ) throws IOException, FormatoInvalidoExcepcion
    {
        super( br );
    }
    ...
    public void pintar( Graphics2D g )
    {
        ...
        g.fillRect( x + MARGEN_CONSTRUCCION / 2, y + MARGEN_CONSTRUCCION / 2, ancho - MARGEN_CONSTRUCCION / 2, alto - MARGEN_CONSTRUCCION );
        ...
        g.drawLine( x + MARGEN_CONSTRUCCION / 2, y + 1, x + MARGEN_CONSTRUCCION / 2, y + alto - 2 - MARGEN_CONSTRUCCION / 2 );
        ...
        g.drawLine( x + MARGEN_CONSTRUCCION / 2, y - MARGEN_CONSTRUCCION / 2 + alto - 2, x + ancho - 2, y - MARGEN_CONSTRUCCION / 2 + alto - 2 );
