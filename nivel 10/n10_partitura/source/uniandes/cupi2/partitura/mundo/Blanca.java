/**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
 * $Id: Blanca.java 600 2006-11-06 06:16:53Z da-romer $
...
/**
 * Esta es una clase que representa una blanca en la partitura
 */
public class Blanca extends Nota
{

    // -----------------------------------------------------------------
    // Constantes
    // -----------------------------------------------------------------
    public static final double DURACION = 2;

    public static final String CLASE = "Blanca";
    ...
    /**
     * Construye una blanca
     * @param nom El nombre de la blanca
     * @param tip El tipo de la blanca
     * @param co Color de la blanca
     */
    public Blanca( String nom, String tip, Color co )
    {
        super( nom, tip, co );
    ...
    /**
     * Crea la blanca a partir de los datos contenidos en un archivo
     ...
     */
    public Blanca( BufferedReader br ) throws IOException, FormatoInvalidoExcepcion
    {
        super( br );
