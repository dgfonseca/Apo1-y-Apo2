...
/**
 * Esta clase representa un rectángulo que hace parte de una composición. <br>
 * <b>inv:</b> <br>
 * rectangulo!=null
 */
public class Rectangulo extends FiguraRellena
{
    ...
    /**
     * Construye un rectángulo a partir de los datos contenidos en un archivo
    ...
    protected void verificarInvariante( )
    {
        ...
        assert rectangulo != null : "La representación gráfica del rectángulo no debería ser null";
    }
}