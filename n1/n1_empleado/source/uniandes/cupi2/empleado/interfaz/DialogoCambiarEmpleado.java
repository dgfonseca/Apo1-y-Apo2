...
public class DialogoCambiarEmpleado extends JDialog implements ActionListener
{
    ...
    public void actionPerformed( ActionEvent pEvento )
    {
        ...
        if( comando.equals( ACEPTAR ) )
        {
            ...
            Fecha fechaIngreso2 = new Fecha( fechaIngreso.getDate( ), fechaIngreso.getMonth( ), fechaIngreso.getYear( ) + 1900 );
            Date fechaNacimiento = dcFechaNacimiento.getDate( );
            Fecha fechaNacimiento2 = new Fecha( fechaNacimiento.getDate( ), fechaNacimiento.getMonth( ), fechaNacimiento.getYear( ) + 1900 );
